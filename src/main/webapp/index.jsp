...
<body>
    ...
    <section class="contenedor dos-columnas">
        <div>
            ...
            <a class="inline-block boton" href="/CitasMedicas/PacDocsServlet?accion=show">Ver Doctores</a>
        </div>
        <div>
    ...
    <section class="seccion imagen-contacto">
        ...
        <a class="boton" href="/CitasMedicas/SigninServlet?accion=show">Sign In</a>
    </section>
